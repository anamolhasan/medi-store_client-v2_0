'use client'
import { deleteMedicine, updateMedicine } from '@/actions/medicine.action'
...
const medicineSchema = z.object({
  ...
  .min(3, 'Description must be at least at least 3 characters long'),
  price: z.number().min(1, 'Price must be at lest 1'),
                                ...
                                <div className="relative h-32 w-32 overflow-hidden rounded-xl border bg-muted">
                                    <Image
                                        src={
                                            ...
                                            "https://unsplash.com/photos/white-and-blue-medication-pill-blister-pack-jwWtZrm67VI"
                                        }
                                        alt={selectedMedicine.name}
                                        fill
