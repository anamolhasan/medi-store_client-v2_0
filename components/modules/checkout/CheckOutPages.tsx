...
import { addToCheckout, CheckoutItem, clearCheckout, removeFromCheckout, removeOneFromCheckout } from "@/store/slice/checkoutSlice";
...
export default function CheckOutPages({ user }: { user: User }) {
